...
# Scope rules -- which water each fishery-year's `b` is fit to -- live in
...
# ------------------------------------------------------------------------------
# Angler-type recoding and section realignment live in R_functions/, shared
# with template_scripts/fw_creel.Rmd so a production render applies exactly
# the same corrections this script does. See that file for why each is needed.
# ------------------------------------------------------------------------------
source(here::here("R_functions", "bss_input_fixes.R"))
