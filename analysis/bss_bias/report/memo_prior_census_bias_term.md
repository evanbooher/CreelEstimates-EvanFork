...
Where census (tie-in) counts are reduced this season, WDFW proposes to carry the effort-index bias term forward from prior years as an informative prior rather than leave it unconstrained.
